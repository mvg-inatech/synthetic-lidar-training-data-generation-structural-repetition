...
# As suggested by the pytorch OOM error msg that only appeared for this experiment
...
DATASET=subway
CONFIG="exp6-semseg-oacnns-v1m1-0-subway-50ep"
EXP_NAME=exp6_oacnns_merged_training_50ep
WEIGHT="None"
RESUME=false
NUM_GPU=None
NUM_MACHINE=1
