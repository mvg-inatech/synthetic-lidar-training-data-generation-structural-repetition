...
DATASET=subway
CONFIG="exp3-semseg-sonata-v1m1-0c-subway-ft-tune-lr-0.0005-50ep"
EXP_NAME=exp3_sonata_tune_lr_0.0005_50ep
WEIGHT="exp/sonata/pretrain-sonata-v1m1-0-base.pth" # Sonata checkpoint provided by authors, downloaded from HuggingFace, see https://github.com/Pointcept/Pointcept/tree/main/pointcept/models/sonata#4-probing-and-tuning for instructions and https://github.com/facebookresearch/sonata?tab=readme-ov-file#quick-start for weight download
RESUME=false
NUM_GPU=None
NUM_MACHINE=1
DIST_URL="auto"
