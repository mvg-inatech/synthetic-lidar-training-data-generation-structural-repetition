...
DATASET=stsd
CONFIG="exp11-12-semseg-oacnns-v1m1-0-stsd-100ep"
EXP_NAME=exp11_oacnns_finetune_on_stsd_100ep
WEIGHT="exp/subway/exp4_oacnns_long_training_100ep/model/model_best.pth"
RESUME=false
NUM_GPU=None
NUM_MACHINE=1
DIST_URL="auto"
