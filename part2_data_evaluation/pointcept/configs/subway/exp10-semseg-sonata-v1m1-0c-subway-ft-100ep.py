...
hooks = [
    dict(
        ...
        reinit_ptv3_stem_channels_map={  # Map channels from 9ch pretrained weights to 6ch model
            # Target channel 0, 1, 2 (coord) -> Source channel 0, 1, 2 (coord)
            0: 0,
            1: 1,
            2: 2,
            # Discard the color channels from the loaded weights (indices 3-5)
            # Target channel 3, 4, 5 (normal) -> Source channel 6, 7, 8 (normal)
            3: 6,
            4: 7,
            5: 8,
        },
        reinit_ptv3_stem_channels=[],
    ),
