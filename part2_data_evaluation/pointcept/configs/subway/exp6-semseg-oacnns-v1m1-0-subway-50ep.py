...
# Use 50 instead of 100 ep to ensure comparability to exp4, since we have twice the amount of training data here
epoch = 50
...
train_split = ["synth_train"]
train_split.extend(["real_train"] * 301)  # Oversample real_train (13 items) to approximately match the 3919 items in synth_train
